var l=Object.defineProperty;var r=(e,t)=>l(e,"name",{value:t,configurable:!0});import{d as i,g as d,k as p,m,a as c,b as y,w as g,p as h,e as I,n as v,o as f}from"./vue.esm-bundler.6bcdb6b4.js";import{_ as b}from"./_plugin-vue_export-helper.12824e74.js";const s=i({name:"MInput",props:{width:{type:String},height:{type:String},value:{type:[String,Boolean]},disabled:{type:Boolean},type:{type:String,default:"text"}},setup(e,{emit:t}){e=d(e);let n;return e.type==="text"?n=p(e.value):n=p(e.value),m(()=>e.value,a=>{a!==void 0&&(n.value=a.toString())}),{inputType:e.type,styles:c(()=>({width:e.width,height:e.height})),inputValue:n,onInput(){t("input",n.value)},onChange(){t("change",n.value)}}}});const _={class:"minput"},M=["type","disabled"];function x(e,t,n,a,C,k){return f(),y("div",_,[g(I("input",{type:e.type,class:"minput-body",style:v(e.styles),onInput:t[0]||(t[0]=(...o)=>e.onInput&&e.onInput(...o)),onChange:t[1]||(t[1]=(...o)=>e.onChange&&e.onChange(...o)),"onUpdate:modelValue":t[2]||(t[2]=o=>e.inputValue=o),disabled:e.disabled},null,44,M),[[h,e.inputValue]])])}r(x,"_sfc_render");const u=b(s,[["render",x],["__scopeId","data-v-1fc4561a"]]);s.__docgenInfo={displayName:"MInput",exportName:"default",description:"",tags:{},props:[{name:"width",type:{name:"string"}},{name:"height",type:{name:"string"}},{name:"value",type:{name:"string|boolean"}},{name:"disabled",type:{name:"boolean"}},{name:"type",type:{name:"string"},defaultValue:{func:!1,value:'"text"'}}]};const $={parameters:{storySource:{source:`import MInput from "../components/MInput/MInput.vue";\r
\r
export default {\r
...
//# sourceMappingURL=Input.stories.e6cee354.js.map
